  ...
  return (
    <div className="min-h-screen bg-black bg-opacity-72 mb-16 relative">
      ...
      <div className="relative bg-black">
        ...
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center mb-32  text-white bg-black bg-opacity-50 p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto justify-items-center">
        {[...Array(16)].map((_, i) => (
          <div key={i} className="bg-white rounded-xl shadow-md w-full max-w-xs transform transition-transform duration-200 hover:scale-105"> {/* Added hover effect */}
            <img
      ...
      <div className='bg-black pt-6 pb-6 mt-14'>
        <div className='container mx-auto flex flex-col md:flex-row gap-2 items-start justify-start'>
          {/* Column for Image */}
          <div className='w-full md:w-1/3 mb-6 md:mb-0 mx-auto'>
            <img
...
<div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
  {[{
    ...
    },
    {
      ...
      title: "Proficient Chauffeur Service",
      description: "Elevate Your Airport Experience with Our Premier Chauffeur Service.."
    },
    {
    ...
    <div 
      ...
      <div className="relative bg-black w-full p-8">
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center gap-8"> {/* Centered items */}
          {/* Google Map */}
          <div className="lg:w-1/2 w-full flex pl-32  justify-center"> {/* Centered map */}
            <iframe 
              ...
              className="mx-auto w-full h-96 rounded-lg"
              allowFullScreen 
              loading="lazy">
            </iframe>
          </div>
          ...
          {/* Book a Ride Text */}
          <div className="lg:w-1/2 w-full text-white lg:text-left text-center mt-6 pb-20">

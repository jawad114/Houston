...
<div className="relative hidden lg:block">
  ...
  <div className="absolute bottom-0 left-0 w-20 h-20 bg-orange-500 text-white flex items-center justify-center text-2xl font-bold rounded-xl z-10 ml-9 mb-28 shadow-lg border-4 border-black">
    25+
      ...
      <div className="flex flex-col justify-center space-y-6 text-center px-4 lg:hidden">
  <span className="text-orange-500 font-semibold text-xl uppercase ">Who We Are</span>
  <h2 className="text-4xl sm:text-5xl text-white font-bold">We are committed to excellence</h2>
  <p className="text-gray-300 text-base sm:text-lg text-left">
    With years of experience, we have been providing top-notch services
    to our clients. We pride ourselves on delivering quality and exceeding
    ...
    With years of experience, we have been providing top-notch services to our clients. We pride ourselves on delivering quality and exceeding expectations in every project.
      ...
      <div className="relative lg:hidden flex flex-col items-start ml-24 mb-96 space-y-6 mt-32" style={{marginBottom:"500px"}}>
  {/* Upper Image */}
  <img
    src={upperImage}
    alt="Upper Image"
  ...
  {/* Small Orange Card */}
  <div className="absolute bottom-0 left-0 w-20 h-20 bg-orange-500 text-white flex items-center justify-center text-2xl font-bold rounded-xl z-10 ml-9 mt-96 shadow-lg border-4 border-black" style={{marginBottom:"-300px"}}>
    25+
  </div>
</div>
      {/* New Section with Full-Width Background and Overlay */}
<div className="relative mt-60 hidden lg:block"> {/* Use hidden on small screens and block on large screens */}
  ...
  <div className="relative">
    ...
    <div className="absolute inset-0 flex items-center justify-center mx-32">
      ...
      <div className="container mx-auto py-12 grid grid-cols-1 lg:grid-cols-2 gap-12 my-16 px-4">
        ...
        <div className="flex flex-col justify-center space-y-6 text-white sm:ml-14">
